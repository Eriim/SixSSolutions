...
<body>
	...
	<form class = "formConsultant" action="CreateConsultantServlet" method = "post">
		
		
		<label for = "workPhone">Work Phone</label>
		<input class="formConsultant" type="text" name = "workPhone"><br>
		<label for = "isAdmin">Admin </label>
		<input class="formConsultant"type="radio" name = "isAdmin" value="true">Yes<br>
